...
## Policy Design Approach 3 {background-image="libs/Images/background-forest_v3.png" background-size="1920px 1080px"}
...
## Elinor Ostrom (1933-2012) {background-image="libs/Images/background-forest_v3.png" background-size="1920px 1080px"}
...
## NOBEL PRIZE WINNER Elinor Ostrom {background-image="libs/Images/background-forest_v3.png" background-size="1920px 1080px"}
...
## Common Pool Resources (CPR) {background-image="libs/Images/background-forest_v3.png" background-size="1920px 1080px" .center}
...
## Ostrom's Design Principles {background-image="libs/Images/background-forest_v3.png" background-size="1920px 1080px" .center}
...
## 2. Match Rules to Local Conditions {background-image="libs/Images/13-1-Philippines_rice_terraces.jpg"}
...
## 4. Monitoring {background-image="libs/Images/13-1-water_testing.jpg"}
...
## 5. Graduated Sanctions {background-image="libs/Images/13-1-slap-on-wrist.jpg"}
...
## 6. Conflict-Resolution Mechanisms {background-image="libs/Images/13-1-mediation.png"}
...
## 7. Recognition of Rights to Organize {background-image="libs/Images/13-1-right-to-organize.jpg"}
...
## 8. Nested Enterprises {background-image="libs/Images/13-1-nested_levels.png"}
...
## For Next Class {background-image="libs/Images/background-forest_v3.png" background-size="1920px 1080px" .center}
