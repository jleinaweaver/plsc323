...
## {background-image="libs/Images/06-1-wicklow_path.jpg" .center}
...
## {background-image="libs/Images/06-1-Inflation.png" .center}
...
## Choice 1 {background-image="libs/Images/background-forest_v3.png" .center}
...
```{r, fig.align='center'}
knitr::include_graphics("libs/Images/06-1-choices.jpg")
```
...
## Choice 2 {background-image="libs/Images/background-forest_v3.png" .center}
...
## Choice 3 {background-image="libs/Images/background-forest_v3.png" .center}
...
## {background-image="libs/Images/06-1-choices.jpg" .center}
...
## {background-image="libs/Images/06-1-lightbulb.jpeg"}
...
## {background-image="libs/Images/06-1-flooding.jpg"}
...
## Pindyck, R. S. (2007). Uncertainty in Environmental Economics. *Review of Environmental Economics and Policy*. 1(1), 45–65. {background-image="libs/Images/background-forest_v3.png" .center}
