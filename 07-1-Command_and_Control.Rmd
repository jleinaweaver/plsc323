...
### Questions to answer from student responses to Google Form
- This is the exact same amount of readings as before, just a different order.
    - Moving policy design approaches forward in the class.
    
- Deadline for paper 2 pushed back to give us more time to explore the approaches before writing the next paper.

- No "midterm" in this class. Just the big project we're working on all semester.

- Revisions for paper 1 are due two weeks from the feedback email I sent you (as is written on the feedback itself)
...
Aim is to find an example of a SPECIFIC C&C regulation targeted at a problem that looks like the one you are working on.

- Impacting similar resources?
- Impacting similar stakeholders?
- etc.
...
You MUST submit a citation to your case evidence before class.

### Questions?

*Send class email to shared document*