...
**Resources placed under serious strain when...**
...
::: {.fragment}
**Problems complicated by free-riding when...**
...
The first type of collective action problem you may encounter is the "Hardin-type tragedy of the commons"

- **Give me an example of this dynamic complicating one of your local environmental problems**

<br>

**What kinds of policy designs help us if this is the complication we face?**
...
**REVEAL**: The second complication is often referred to as athe free-rider problem

- **What does that mean? e.g. What is a free-rider?**

- (Someone who enjoys the benefits of other peoples’ efforts without contributing to the provision of those benefits)

<br>

**Under what conditions is the free-rider problem magnified? e.g. Per Olson, when is free-riding a BIG problem?**
...
**SLIDE**: And that was the state of things until about a week ago the administration acted!
...
::: {.column width="50%"}
```{r, fig.align='center'}
knitr::include_graphics("libs/Images/13_2-New_EPA_Rule_Cancer_Alley.png")
```
:::
...
```{r, fig.align='center'}
knitr::include_graphics("libs/Images/13_2-New_EPA_Rule_Cancer_Alley2.png")
```
:::
::::
...
Rather than getting bogged down in a fight with Lousiana's state government, update the EPA rules for chemical factory pollution!

- Its been 20 years since the last update

- Now they are putting in place rules that will reduce chemical factory pollution across the country
