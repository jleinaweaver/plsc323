...
```{r, fig.retina=3, fig.asp=0.8, fig.align='center', out.width='72%', fig.width=6, cache=TRUE}
...
.center[.size45[.content-box-green[**1. Green taxes offer more efficient pollution control**]]]
...
background-image: url('libs/Images/08_1-Manufacturing-industry.jpg')
background-size: 100%
background-position: center
class: bottom

.center[.size50[.content-box-green[**2. Green taxes are relatively easier to design**]]]
...
.center[.size50[.content-box-green[**3. Green taxes incentivize innovation**]]]

```{r, fig.retina=3, fig.asp=0.72, fig.align='center', out.width='70%', fig.width=7, cache=TRUE}
tibble(
  Price = 1:100,
  Quantity = 100:1
) |>
...
.size50[.content-box-green[**Policy Design Option 3: "Green" Subsidies**]]
...
```{r, fig.retina=3, fig.asp=0.618, fig.align='center', out.width='98%', fig.width=6, cache=FALSE}
tibble(
  Abatement_cost = 0:100,
  Pollution = 0:100
) |>
...
```{r, fig.retina=3, fig.asp=0.618, fig.align='center', out.width='98%', fig.width=6, eval=FALSE}
...
.pull-left[
```{r, fig.retina=3, fig.align='center', out.width='100%', fig.asp=0.85, fig.width=5.5, eval=FALSE}
...
.pull-right[
```{r, fig.retina=3, fig.align='center', out.width='100%', fig.asp=0.85, fig.width=5.5, cache=FALSE}
