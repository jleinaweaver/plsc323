...
## 1. Globalisation is imperialism by another name {background-image="libs/Images/background-forest_v3.png" .center}
...
## 2. Environmentalism + Capitalism = Bad Ecological Outcomes {background-image="libs/Images/background-forest_v3.png" .center}

```{r, fig.align='center'}
knitr::include_graphics('libs/Images/13-1-patagonia_dont_buy_jacket.png')
```
...
## 3. We are rapidly consuming the world while feeling better and better about our choices {background-image="libs/Images/13-1-recycling_myths_v2.png" .center}
...
```{r, fig.align='center'}
knitr::include_graphics('libs/Images/13-1-toxic_america.webp')
```
...
## Dauvergne's Argument {background-image="libs/Images/background-forest_v3.png" .center .smaller}
