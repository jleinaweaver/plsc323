...
## Assignment 4 {background-image="Images/background-forest_v3.png" .center}
...
## {background-image="Images/01-1-ozarks_forest.jpg" .center}

::: {.r-fit-text}
<p style="color: white;">**An Effective Policy Designer Must...**</p>
:::

<br>

```{r, fig.align='center'}
knitr::include_graphics('Images/02-1-cavemen.jpg')
```

<br>

::: {.r-fit-text}
<p style="color: white;">**Consider why Policies Exist**</p>
:::
...
```{r, fig.align='center'}
knitr::include_graphics('Images/03-1-nos_yeses.jpg')
```

<br>

::: {.r-fit-text}
<p style="color: white;">**Consider the "Politics"**</p>
:::
...
```{r, fig.align='center'}
knitr::include_graphics('Images/03-1-flower_pavement.jpg')
```

<br>

::: {.r-fit-text}
<p style="color: white;">**Consider the "Problem"**</p>
:::
...
```{r, fig.align='center'}
knitr::include_graphics('Images/04_2-scales.jpg')
```

<br>

::: {.r-fit-text}
<p style="color: white;">**Consider the "Baseline"**</p>
:::
...
```{r, fig.align='center'}
knitr::include_graphics('Images/03-1-problem_solving_process.gif')
```

<br>

::: {.r-fit-text}
<p style="color: white;">**Consider the "Domestic Process"**</p>
:::
...
```{r, fig.align='center'}
knitr::include_graphics('Images/03-1-new_plan.jpg')
```

<br>

::: {.r-fit-text}
<p style="color: white;">**Present a Complete Proposal**</p>
:::
...
## A Possible (and evolving?) Process {background-image="Images/background-forest_v3.png" .center}
...
## Paper 1: Introducing the Problem {background-image="Images/background-forest_v3.png" .center}
...
## {background-image="Images/03-1-stakeholders.webp"}
...
## What can we learn from the stakeholders' public arguments that will help us broaden the appeal of our "we have a problem" argument? {background-image="Images/03-1-stakeholders_v2.png" .center}
...
## The CAFE Standards Debate {background-image="Images/background-forest_v3.png" .center}
...
```{r, cache=TRUE, fig.asp=.618, fig.width = 9}
...
d |>
  ...
  annotate("rect", xmin = 1974, xmax = 1977, ymin = 0, ymax = 30, fill = "red", alpha = .1) +
  annotate("text", x = 1975.5, y = 1, label = "Gerald Ford", color = "red") +
  geom_point() +
  geom_line() +
  theme_bw() +
  ...
  labs(x = "", y = "miles per gallon (mpg)",
       title = "Corporate Average Fuel Economy (CAFE) Standards Across Time",
...
Let's explore the story of CAFE in wildly oversimplified terms

- Note that CAFE applies to both cars and light duty trucks but for now I just want to focus on cars.
...
d |>
  ...
  labs(x = "", y = "miles per gallon (mpg)",
       title = "Corporate Average Fuel Economy (CAFE) Standards Across Time",
       caption = "Source: Department of Energy") +
  annotate("point", x = 1985, y = 27.5, size = 3, color = "darkblue") +
  annotate("text", x = 1985, y = 25, label = "CAFE\n(1975)", color = "darkblue")
...
d |>
  ...
  annotate("rect", xmin = 1974, xmax = 1977, ymin = 0, ymax = 30, fill = "red", alpha = .1) +
  annotate("text", x = 1975.5, y = 1, label = "Gerald Ford", color = "red") +
  annotate("rect", xmin = 1977, xmax = 1981, ymin = 0, ymax = 30, fill = "blue", alpha = .1) +
  annotate("text", x = 1979, y = 1, label = "Jimmy Carter", color = "blue") +
  geom_point() +
  geom_line() +
  theme_bw() +
  scale_y_continuous(limits = c(0, 30), breaks = seq(0, 30, 10)) +
...
Despite the fear-mongering, Carter gets elected and he keeps the proverbial train rolling ahead.

- HOWEVER, his time in office is notoriously ROUGH

<br>

Iran takes Americans hostage, Carter fails to free them and this ushers in the era of:
...
d |>
  ...
  annotate("rect", xmin = 1977, xmax = 1981, ymin = 0, ymax = 30, fill = "blue", alpha = .1) +
  annotate("text", x = 1979, y = 1, label = "Jimmy Carter", color = "blue") +
  annotate("rect", xmin = 1981, xmax = 1989, ymin = 0, ymax = 30, fill = "red", alpha = .1) +
  annotate("text", x = 1985, y = 1, label = "Ronald Reagan", color = "red") +
  geom_point() +
  geom_line() +
  theme_bw() +
  #scale_y_continuous(limits = c(0, 70), breaks = seq(0, 70, 10)) +
  ...
  annotate("point", x = 1985, y = 27.5, size = 3, color = "darkblue") +
  annotate("text", x = 1985, y = 25, label = "CAFE\n(1975)", color = "darkblue") +
  annotate("point", x = 1986:1988, y = 26, size = 3, color = "red") +
  annotate("text", x = 1987, y = 23.5, label = "CAFE\n('86-'88)", color = "red")
```
...
d |>
  ...
  annotate("rect", xmin = 1981, xmax = 1989, ymin = 0, ymax = 30, fill = "red", alpha = .1) +
  annotate("text", x = 1985, y = 1, label = "Ronald Reagan", color = "red") +
  annotate("rect", xmin = 1989, xmax = 1993, ymin = 0, ymax = 30, fill = "red", alpha = .1) +
  annotate("text", x = 1991, y = 1, label = "HW Bush", color = "red") +
  geom_point() +
  geom_line() +
  theme_bw() +
  #scale_y_continuous(limits = c(0, 70), breaks = seq(0, 70, 10)) +
  scale_y_continuous(limits = c(0, 30), breaks = seq(0, 30, 10)) +
  scale_x_continuous(limits = c(1974, 1993), breaks = 1974:1993) +
  annotate("point", x = 1975, y = 13, color = "red", size = 3) +
  labs(x = "", y = "miles per gallon (mpg)",
       title = "Corporate Average Fuel Economy (CAFE) Standards Across Time",
       caption = "Source: Department of Energy") +
  annotate("point", x = 1985, y = 27.5, size = 3, color = "darkblue") +
  annotate("text", x = 1985, y = 25, label = "CAFE\n(1975)", color = "darkblue") +
  annotate("text", x = 1991, y = 25, label = "CAFE\n(1975)", color = "darkblue") +
  annotate("point", x = 1990:1992, y = 27.5, size = 3, color = "darkblue") +
  annotate("point", x = 1986:1988, y = 26, size = 3, color = "red") +
  annotate("text", x = 1987, y = 23.5, label = "CAFE\n('86-'88)", color = "red")
```
...
Presidency passes from Reagan to his VP, George HW Bush

- In 1989 the three year pause on CAFE standards is ended and we return to the 1986 standard

<br>

So, economic crisis leads to rapid progress and then we completely stalled out for a couple of decades.

- I'm starting to think that elections might matter for environmental policy progress...
...
d |>
  ...
  ggplot(aes(x = Year, y = passenger_cars)) +
  annotate("rect", xmin = 1974, xmax = 1977, ymin = 0, ymax = 30, fill = "red", alpha = .1) +
  annotate("text", x = 1975.5, y = 1, label = "Ford", color = "red") +
  annotate("rect", xmin = 1977, xmax = 1981, ymin = 0, ymax = 30, fill = "blue", alpha = .1) +
  annotate("text", x = 1979, y = 1, label = "Carter", color = "blue") +
  annotate("rect", xmin = 1981, xmax = 1989, ymin = 0, ymax = 30, fill = "red", alpha = .1) +
  annotate("text", x = 1985, y = 1, label = "Reagan", color = "red") +
  annotate("rect", xmin = 1989, xmax = 1993, ymin = 0, ymax = 30, fill = "red", alpha = .1) +
  annotate("text", x = 1991, y = 1, label = "HW Bush", color = "red") +
  annotate("rect", xmin = 1993, xmax = 2001, ymin = 0, ymax = 30, fill = "blue", alpha = .1) +
  annotate("text", x = 1997, y = 1, label = "Clinton", color = "blue") +
  annotate("rect", xmin = 1995, xmax = 2000, ymin = 25, ymax = 30, fill = "red", alpha = .3) +
  geom_point() +
  geom_line() +
  theme_bw() +
  #scale_y_continuous(limits = c(0, 70), breaks = seq(0, 70, 10)) +
  scale_y_continuous(limits = c(0, 30), breaks = seq(0, 30, 10)) +
  scale_x_continuous(limits = c(1974, 2001), breaks = seq(1974, 2001, 2)) +
  annotate("point", x = 1975, y = 13, color = "red", size = 3) +
  labs(x = "", y = "miles per gallon (mpg)",
       title = "Corporate Average Fuel Economy (CAFE) Standards Across Time",
       caption = "Source: Department of Energy") +
...
To be clear, by 2000 cars and trucks were LESS efficient than they were a decade earlier (about 1mpg worse)

- Lowered standards

- Increased truck and SUV sales

<br>

Also note, this lack of progress was NOT helping the American automotive industry

- Throughout the late 1980s and 1990s US manufacturers are getting their lunch eaten by the Japanese and other countries with more stringent standards and more efficient cars on the market

- So, Congress and the presidents succeeded in harming both the environment and the economy!
...
d |>
  ...
  annotate("rect", xmin = 1993, xmax = 2001, ymin = 0, ymax = 30, fill = "blue", alpha = .1) +
  annotate("text", x = 1997, y = 1, label = "Clinton", color = "blue") +
  annotate("text", x = 2005, y = 1, label = "GW Bush", color = "red") +
  annotate("rect", xmin = 2001, xmax = 2008, ymin = 0, ymax = 30, fill = "red", alpha = .1) +
  annotate("rect", xmin = 1995, xmax = 2000, ymin = 25, ymax = 30, fill = "red", alpha = .3) +
  geom_point() +
  geom_line() +
  theme_bw() +
...
GWB elected and CAFE standards remain frozen at 1986 levels until 2007

- Functionally, while the world auto fleets grew more efficient, no new activity on this for almost 20 years in the US
...
d |>
  filter(Year < 2008) |> 
  ggplot(aes(x = Year, y = passenger_cars)) +
  annotate("rect", xmin = 1974, xmax = 1977, ymin = 0, ymax = 40, fill = "red", alpha = .1) +
  annotate("text", x = 1975.5, y = 1, label = "Ford", color = "red") +
  annotate("rect", xmin = 1977, xmax = 1981, ymin = 0, ymax = 40, fill = "blue", alpha = .1) +
  annotate("text", x = 1979, y = 1, label = "Carter", color = "blue") +
  annotate("rect", xmin = 1981, xmax = 1989, ymin = 0, ymax = 40, fill = "red", alpha = .1) +
  annotate("text", x = 1985, y = 1, label = "Reagan", color = "red") +
  annotate("rect", xmin = 1989, xmax = 1993, ymin = 0, ymax = 40, fill = "red", alpha = .1) +
  annotate("text", x = 1991, y = 1, label = "HWB", color = "red") +
  annotate("rect", xmin = 1993, xmax = 2001, ymin = 0, ymax = 40, fill = "blue", alpha = .1) +
  annotate("text", x = 1997, y = 1, label = "Clinton", color = "blue") +
  annotate("text", x = 2005, y = 1, label = "GWB", color = "red") +
  annotate("rect", xmin = 2001, xmax = 2009, ymin = 0, ymax = 40, fill = "red", alpha = .1) +
  annotate("rect", xmin = 1995, xmax = 2000, ymin = 25, ymax = 30, fill = "red", alpha = .3) +
  geom_point() +
  geom_line() +
  theme_bw() +
  ...
  annotate("point", x = 1975, y = 13, color = "red", size = 3) +
  annotate("point", x = 2020, y = 35, color = "red", size = 3) +
  annotate("segment", x = 2007, xend = 2020, y = 27.5, yend = 35, linetype = "dashed", color = "red") +
  labs(x = "", y = "miles per gallon (mpg)",
       title = "Corporate Average Fuel Economy (CAFE) Standards Across Time",
       caption = "Source: Department of Energy")
```
...
- War on Terrorism + wars in Iraq and Afghanistan are messing up oil markets

- US automakers producing cars the rest of the world doesn't want

- US consumers buying international cars
...
d |>
  ...
  annotate("rect", xmin = 2001, xmax = 2009, ymin = 0, ymax = 40, fill = "red", alpha = .1) +
  annotate("rect", xmin = 1995, xmax = 2000, ymin = 25, ymax = 30, fill = "red", alpha = .3) +
  annotate("rect", xmin = 2009, xmax = 2017, ymin = 0, ymax = 40, fill = "blue", alpha = .1) +
  annotate("text", x = 2013, y = 1, label = "Obama", color = "blue") +
  geom_point() +
  geom_line() +
  theme_bw() +
  scale_y_continuous(limits = c(0, 40), breaks = seq(0, 40, 10)) +
...
d |>
  filter(Year < 2017) |> 
  ggplot(aes(x = Year, y = passenger_cars)) +
  annotate("rect", xmin = 1974, xmax = 1977, ymin = 0, ymax = 60, fill = "red", alpha = .1) +
  annotate("text", x = 1975.5, y = 1, label = "Ford", color = "red") +
  annotate("rect", xmin = 1977, xmax = 1981, ymin = 0, ymax = 60, fill = "blue", alpha = .1) +
  annotate("text", x = 1979, y = 1, label = "Carter", color = "blue") +
  annotate("rect", xmin = 1981, xmax = 1989, ymin = 0, ymax = 60, fill = "red", alpha = .1) +
  annotate("text", x = 1985, y = 1, label = "Reagan", color = "red") +
  annotate("rect", xmin = 1989, xmax = 1993, ymin = 0, ymax = 60, fill = "red", alpha = .1) +
  annotate("text", x = 1991, y = 1, label = "HWB", color = "red") +
  annotate("rect", xmin = 1993, xmax = 2001, ymin = 0, ymax = 60, fill = "blue", alpha = .1) +
  annotate("text", x = 1997, y = 1, label = "Clinton", color = "blue") +
  annotate("text", x = 2005, y = 1, label = "GWB", color = "red") +
  annotate("rect", xmin = 2001, xmax = 2009, ymin = 0, ymax = 60, fill = "red", alpha = .1) +
  annotate("rect", xmin = 1995, xmax = 2000, ymin = 25, ymax = 30, fill = "red", alpha = .3) +
  annotate("rect", xmin = 2009, xmax = 2017, ymin = 0, ymax = 60, fill = "blue", alpha = .1) +
  annotate("text", x = 2013, y = 1, label = "Obama", color = "blue") +
  geom_point() +
  geom_line() +
  theme_bw() +
...
d |>
  ...
  annotate("rect", xmin = 2009, xmax = 2017, ymin = 0, ymax = 60, fill = "blue", alpha = .1) +
  annotate("text", x = 2013, y = 1, label = "Obama", color = "blue") +
  annotate("rect", xmin = 2017, xmax = 2021, ymin = 0, ymax = 60, fill = "red", alpha = .1) +
  annotate("text", x = 2019, y = 1, label = "Trump", color = "red") +
  geom_point() +
  geom_line() +
  theme_bw() +
  scale_y_continuous(limits = c(0, 60), breaks = seq(0, 60, 10)) +
...
d |>
  ...
  annotate("rect", xmin = 2017, xmax = 2021, ymin = 0, ymax = 60, fill = "red", alpha = .1) +
  annotate("text", x = 2019, y = 1, label = "Trump", color = "red") +
  annotate("rect", xmin = 2021, xmax = 2025, ymin = 0, ymax = 60, fill = "blue", alpha = .1) +
  annotate("text", x = 2023, y = 1, label = "Biden", color = "blue") +
  geom_point() +
  geom_line() +
  theme_bw() +
  scale_y_continuous(limits = c(0, 60), breaks = seq(0, 60, 10)) +
...
## Analyzing the Stakeholders {background-image="Images/background-forest_v3.png" .center}
...
## 1) How do they frame the problem? {background-image="Images/background-forest_v3.png" .center}
...
knitr::include_graphics("Images/04_2-Salesman.jpg")
```
:::
::::
...
knitr::include_graphics("Images/04_2-foreign_oil_cartoon.jpg")
```

```{r, echo = FALSE, fig.align = 'center'}
knitr::include_graphics("Images/04_2-climate_change_impacts.jpg")
```
:::

::: {.column width="50%"}
```{r, echo = FALSE, fig.align = 'center', out.width = '65%'}
knitr::include_graphics("Images/04_2-Terrorism.png")
```

```{r, echo = FALSE, fig.align = 'center', out.width = '65%'}
knitr::include_graphics("Images/04_2-electric_bmw.jpg")
```
:::
::::
