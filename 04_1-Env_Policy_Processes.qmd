...
```{r, echo = FALSE, fig.align = 'center'}
knitr::include_graphics("libs/Images/04_1-Youth-Climate-Strike.png")
```
...
```{r, echo = FALSE, fig.align = 'center'}
knitr::include_graphics("libs/Images/04_1-random_stock_image.png")
```
...
## Let's design our own approach! {background-image="libs/Images/background-forest_v3.png" .center}
