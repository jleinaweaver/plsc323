...
3. Prep Google Form to collect county fair responses AND publish it on Canvas
    ...
    - https://docs.google.com/forms/d/e/1FAIpQLSdvMzhqPVCGP97TcQ1OB3i4GL9Gt0So7Xrt7gOEa0FCB1JqEQ/viewform?usp=sharing&ouid=100952406343405950492
...
d <- tibble(
 heads = c(4, 6, 6, 7, 5, 4, 5, 2, 4, 5, 5, 5, 6, 5, 5, 5, 8),
 tails = 0
)
...
Everybody take a minute to reflect on our material from today

- Get ready to report back your answer to this question
