...
.size40[
Find a real world example of this approach (command and control regulations) being used to address an environmental problem similar to the one you are working on in your project.

Be ready to introduce us to your example with as much detail as you can find.

+ Stakeholders, complications, specific design and effectiveness?
]
