...
.size50[
1. C&C regulations work well when targeting problems that look like...

2. C&C regulations don't work well when targeting problems that look like...
]
...
- One list of problem characteristics that make C&C regulations a good policy choice, AND

- One list of problem characteristics that suggest C&C regulations would struggle to succeed
...
.size50[
1. C&C regulations work well when targeting stakeholders that look like...

2. C&C regulations don't work well when targeting stakeholders that look like...
]
...
- What kinds of stakeholders do C&C regulations work well on, and
