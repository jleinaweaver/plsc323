...
<p style="color: white;">**- Connecting our Process to Policy-making**</p>
...
I think this is a great reading for at least two reasons:

1. It beautifully reinforces the best lessons of last class about what it takes to locate our activism in a real community, and

2. It helps us move into thinking theoretically about HOW to design the policies we need

<br>

**SLIDE**: However, before we get into this approach let's take a detour into discussing one of my favorite human beings: Elinor Ostrom
:::
...
GROUPS, now I want you to apply the principles to our chosen local environmental problem

- **As policy designers, what order should we tackle these challenges in?**

- **In other words, where should our work on this problem begin? Why?**
...
- Which are the easiest principles to implement on our case? Why?

- Which are the hardest principles to implement on our case? Why?
...
**Next Class: The Basics of the Problem - Science!**

Go find us evidence that we can use to deepen our understanding of our chosen environmental problem in terms of the science involved. 

- e.g. Why specifically is this a problem? How does it impact human health? Or society? Or ecosystems? etc.

- This evidence does NOT have to be connected to Springfield. 

- Please don't submit something that has already been submitted.

::: notes

Canvas: The Basics of the Problem - Science!

- Go find us evidence that we can use to deepen our understanding of our chosen environmental problem in terms of the science involved.  We need reports and analyses on the science relevant to our chosen problem (e.g. Why specifically is this a problem? How does it impact human health? Or society? Or ecosystems? etc.). This evidence does NOT have to be connected to our local community. Please don't submit something that has already been submitted.
