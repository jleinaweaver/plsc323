...
*THESE NOTES AND DISCUSSIONS STREAMLINED FOR MEETING ON ZOOM*
...
My goal was for this to help you develop a better intuitive sense of the dynamics of political processes.
...
For most people who hear the word "policy" I would guess their minds jump to government or formal rules.

I think the Munger chapter offers an important broadening of the concept.
...
Normally we'd split into groups to map out the pros and cons of each "wisdom" but, well, Zoom...
...
.center[.size40[**What are the pros and cons of prioritizing "Markets" over the other two?**]]

???

Let's use the chat window and start by focusing on Markets.

### What are the pros and cons of prioritizing this one form of wisdom/source of accountability over the other two? 
#### - In other words, what does this "source of wisdom" do well and what does it do badly? 
...
.center[.size40[**What are the pros and cons of prioritizing "Experts" over the other two?**]]

???

Let's use the chat window and start by focusing on experts.
...
.center[.size40[**What are the pros and cons of prioritizing "Politics" over the other two?**]]
...
I hope this makes clear, once again, that nobody should organize their entire worldview (ideology) around the worship of one of these "wisdoms" to the exclusion of the others.

- Each one does some things well and other things badly.

- Too much reliance on one over the others WILL, almost by definition, lead to bad societal outcomes.

Never forget, ALL policy choices create winners and losers!
- No free lunch!
