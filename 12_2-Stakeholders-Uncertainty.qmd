...
2. Build a Google Form to collect data and prep email to distribute it OR distribute on Canvas
    ...
    - [https://docs.google.com/forms/d/e/1FAIpQLSf16C8QAUGp8QyRDVYj287PnVY1xRTWMZWFN5B5Lc-uISxgsQ/viewform?usp=dialog]()
...
**SLIDE**: Debriefing the river clean-up
...
![](Images/12_2-Volunteer_River1.jpg){.absolute left=0 width="450"}

![](Images/12_2-Volunteer_River2.jpg){.absolute right=0 bottom=150 width="500"}

::: notes

On Tuesday you volunteered with the James River Basin Partnership on a creek clean-up in Silver Springs Park.

- **Given how close that park is to Drury, does anybody ever use its facilities? Go for a walk, a picnic or to play sports?**

<br>

**Big picture, what did you think of the experience as a volunteer?**

- **How does the James River Basin Partnership set-up and facilitate these activities?**

- **Would you volunteer with them again in future?**

<br>

Talk to me about the importance of the activity

- **How does litter clean-up from this spring and creek impact our community?**

- (Brett did a really good job connecting the dots for us from this small spring and creek all the way to the Mississippi and Gulf of Mexico)

<br>

Head's up, our next volunteer trip will take us back to the Springfield Community Gardens next Thursday
...
![](Images/12_2-Inflation-FRED-2026-03.png)
...
![](Images/12_2-Inflation-FRED_longer-2026-03.png)
...
### Have you seen evidence of uncertainty, temporal discounting and differing time horizons in the stakeholders involved in your local environmental problem?

::: notes

Undoubtedly, uncertainty and temporal discounting complicates environmental problem-solving

- Everybody take a minute to reflect on their chosen environmental problem

- Get ready to report back how these elements impact the problem and/or complicate the problem-solving
