...
.center[Cronon, W. (1996). The Trouble with Wilderness or, Getting Back to the Wrong Nature. *Environmental History*. 1(1), 7–28.]]
]

.pull-right[
```{r, echo = FALSE, fig.align = 'center', out.width = '80%'}
knitr::include_graphics("libs/Images/02_1-cronon_uncommonground2.jpg")
```
]
...
background-image: url('libs/Images/02_1-Rockymountain_wilderness.jpg')
background-size: 100%
background-position: center
...
background-image: url('libs/Images/02_1-Rockymountain_wilderness2.png')
background-size: 100%
background-position: center
class: middle, center, inverse

.size50[
.textwhite["Wilderness or wildlands (usually in the plural) are natural environments on Earth that have not been significantly modified by human activity, or any nonurbanized land not under extensive agricultural cultivation."]
]
...
.center[.size55[.content-box-green[**The Trouble with Wilderness**]]]

.pull-left[
```{r, echo = FALSE, fig.align = 'center', out.width = '100%'}
knitr::include_graphics("libs/Images/02_1-Oregon_Wilderness2.png")
```
]

.pull-right[
```{r, echo = FALSE, fig.align = 'center', out.width = '100%'}
knitr::include_graphics("libs/Images/02_1-City_Street3_v2.png")
```
]
...
.size60[**The Trouble with Wilderness**]
...
background-image: url('libs/Images/02_1-Old_Mountain_Climbing_1700pixels.png')
background-size: 65%
background-position: center
class: bottom, center
...
background-image: url('libs/Images/02_1-Wagon_Train.png')
background-size: 100%
background-position: center
class: bottom, center

.size55[.content-box-white[**The Myth of the Frontier**]]
...
### Has Cronon convinced you that the "wilderness myth" exists AND that it is an obstacle to solving environmental problems? Why or why not?
...
.center[.size55[.content-box-green[**Setting the Stage for Problem-Solving**]]]

<br>

.size50[1) All environmental concepts are contested]
...
I think Cronon's arguments help us solve real-world environmental problems by thinking critically about problem definitions.
...
.size50[2) Your chosen definition narrows your options]
...
.size50[3) Many disputes arise from conflicting definitions]
...
.size60[.content-box-green[**Assignment for Thursday**]]
