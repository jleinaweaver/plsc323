...
Don't forget, we are back to the Community Garden on Thursday!
...
**What are the costs and benefits of privatizing the commons?**

<br>

**What are the costs and benefits of using government regulations to protect the commons?**

<br> 

**On balance, how do we choose between those two options?**
...
### Examples of collective action problems in your local, environmental problems?
...
Reflect on our discussions today and what you submitted on Canvas

- Get ready to report back with examples of these dynamics in the local environmental problem you have been working on

- *PRESENT and DISCUSS examples*

<br>

**In these cases, do the policy suggestions from Hardin and Olson help or not? Why?**
...
**Preparing to Target a Stakeholder**

- Let's get ready to make a persuasive argument!
:::

::: notes

Your final paper for this class will be to design an argument tailored to one of the stakeholders involved in your chosen environmental problem

- This needs to be a stakeholder who is either directly contributing to the problem or who is an obstacle to us addressing it.

- We'll get into the details on that next week, but first I have an assignment that will set us up for that paper

<br>

Everybody open the Canvas assignment, read the details and let me know if you have questions

- **Questions on the assignment?**

<br>

Canvas ASSIGNMENT: Preparing to Target a Stakeholder (25 pts)

Our next step in taking effective action in our community depends on generating buy-in from the relevant stakeholders, and that depends on convincing them we have a policy problem. For this assignment I want you to select one of the stakeholders in our community whose actions contribute to your chosen environmental problem (or who is a serious obstacle to addressing it) and prepare to target them with an argument.

1. What is the local environmental problem you are targeting?
2. Who is the stakeholder you are targeting?
3. How does this stakeholder directly contribute to our environmental problem? (explain AND provide evidence)
4. Why does this stakeholder do this "problematic" action(s)? In other words, what benefit do they derive from this action? (explain AND provide evidence)
5. Evaluate this stakeholder in terms of their risk profile. How does their risk aversion or acceptance complicate your efforts to change their behavior?
6. Evaluate this stakeholder in terms of their relationship to time and uncertainty. How do their time horizons on this problem complicate your efforts to change their behavior? 
