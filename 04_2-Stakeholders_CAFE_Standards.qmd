...
## {background-image="libs/Images/01-1-ozarks_forest.jpg" .center}
...
## A Possible (and evolving?) Process {background-image="libs/Images/background-forest_v3.png" .center}
...
## Paper 1: Introducing the Problem {background-image="libs/Images/background-forest_v3.png" .center}
...
## {background-image="libs/Images/03-1-stakeholders.webp"}
...
## What can we learn from the stakeholders' public arguments that will help us broaden the appeal of our "we have a problem" argument? {background-image="libs/Images/03-1-stakeholders_v2.png" .center}
...
## The CAFE Standards Debate {background-image="libs/Images/background-forest_v3.png" .center}
...
## Analyzing the Stakeholders {background-image="libs/Images/background-forest_v3.png" .center}
...
## 1) How do they frame the problem? {background-image="libs/Images/background-forest_v3.png" .center}
