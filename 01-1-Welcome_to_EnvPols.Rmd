...
4. I took versions of all the classes as an undergrad and most more deeply as a grad student
...
### That definition in mind, what's going on in the world of environmental problems / politics?
...
Semester in three chunks.

Each introduces a set of concepts, tools, and cases we can use to develop our skills as policy creators and analysts.

Each section also leads to an assignment.
...
# Your Project: Three Sections 

### Paper 1
.size30[Present the basics of an environmental problem you intend to focus on this term]

### Paper 2
.size30[Analyze the complicating factors related to that problem]

### Paper 3
.size30[Propose a specific policy to address the selected problem]
...
**All** of our readings this term are available on Moodle.

Let me know if you have trouble using our class Moodle site.
