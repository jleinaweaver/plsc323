...
- 1) Less noticeable way to spend money, 2) lowers revenue but doesn't raise spending/debt, 3) we already have a massive tax infrastructure with many other tax credits built into it.

The problem is that this has the capacity to exclude a lot of people from the effects of the subsidy.

### Anybody want to take a stab at why the great majority of tax credits are non-refundable rather than refundable?

- Political messaging strikes again
- Rough stereotypes in our society about who contributes and who doesn't (e.g. Mitt Romney's 47% comments)
    - Bootstraps, dammit! :P
    - Money for me, a hard working person = good; money for you, a drain on society = bad
    
<br>

As an important aside, how big is the whole in a subsidy like this?
